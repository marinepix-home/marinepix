...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
	...
	<link rel="stylesheet" href="canvas/HTML/style.css" type="text/css" />
	<link rel="stylesheet" href="canvas/HTML/css/dark.css" type="text/css" />
	<link rel="stylesheet" href="canvas/HTML/css/font-icons.css" type="text/css" />
	<link rel="stylesheet" href="canvas/HTML/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="canvas/HTML/css/magnific-popup.css" type="text/css" />

	<link rel="stylesheet" href="canvas/HTML/css/responsive.css" type="text/css" />
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="transparent-header page-section dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="canvas/HTML/images/logo-dark.png"><img src="canvas/HTML/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="canvas/HTML/images/logo-dark@2x.png"><img src="canvas/HTML/images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
								...
								<div class="top-cart-items">
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="canvas/HTML/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
										</div>
									...
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="canvas/HTML/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
										</div>
										<div class="top-cart-item-desc">
		...
		<section id="slider" class="slider-parallax full-screen dark error404-wrap" style="background: url(canvas/HTML/images/landing/static.jpg) center;">
					...
					<div class="col_two_third">
						...
						<div class="col_one_third">
							...
							<div class="widget clearfix">
								...
								<img src="canvas/HTML/images/footer-widget-logo.png" alt="" class="footer-logo">

								<p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

								<div style="background: url('canvas/HTML/images/world-map.png') no-repeat center center; background-size: 100%;">
									<address>
	...
	============================================= -->
	<script type="text/javascript" src="canvas/HTML/js/jquery.js"></script>
	<script type="text/javascript" src="canvas/HTML/js/plugins.js"></script>

	<!-- Footer Scripts
	============================================= -->
	<script type="text/javascript" src="canvas/HTML/js/functions.js"></script>
